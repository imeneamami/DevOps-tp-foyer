...
sh 'mvn deploy -s /path/to/actual/settings.xml -DskipTests -DaltDeploymentRepository=deploymentRepo::default::http://192.168.1.12:8081/repository/maven-releases/'
            }
        }
    }
}
